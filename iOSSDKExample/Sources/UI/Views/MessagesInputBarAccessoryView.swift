...
private extension MessagesInputBarAccessoryView {
    ...
    func setupLeftInputButtons() {
        ...
        let attachmentsButton = InputBarButtonItem()
            .configure {
                $0.image = UIImage(systemName: "arrow.up.doc")
                ...
                Task { @MainActor in
                    do {
                        if self.audioRecorder.isRecording {
                            ...
                            self.inputTextView.placeholder = "Recording..."
                            
                        }
                        
                        item.image = self.audioRecorder.isRecording ? UIImage(systemName: "mic.slash") : UIImage(systemName: "mic")
                    } catch {
                        error.logError()
                    }
                }
    ...
    func setupInputTextView() {
        ...
        inputTextView.layer.borderColor = UIApplication.isDarkModeActive ? UIColor.darkGray.cgColor : UIColor.lightGray.cgColor
    ...
    func setupSendInputButton() {
        ...
        sendButton
            ...
            .onEnabled { item in
                item.imageView?.tintColor = .primaryColor
            }
            .onDisabled { item in
                item.imageView?.tintColor = UIApplication.isDarkModeActive ? .darkGray : .lightGray
            }
